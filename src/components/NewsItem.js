...
export class NewsItem extends Component {
    ...
    render() {
        ...
        let title = (this.props.articleData["title"]==null ? " ": this.props.articleData["title"]);
        let description = (this.props.articleData["summary"]==null ? " ": this.props.articleData["summary"]);
                ...
                <div className="col-md-4 my-1">
                    <div className="card bg-custom-1">
                        ...
                        <div className="card-body">
                            <h5 className="card-title text-pink">{title.slice(0,60)+"..."}</h5>
                            <p className="card-text text-light">{description.slice(0,120)+"..."}</p>
